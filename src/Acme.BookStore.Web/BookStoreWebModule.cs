...
public class BookStoreWebModule : AbpModule
{
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        Configure<RazorPagesOptions>(options =>
        {
            ...
            options.Conventions.AuthorizePage("/Books/CreateModalModel", BookStorePermissions.Books.Create);
            ...
            options.Conventions.AuthorizePage("/Attachments/Index", BookStorePermissions.Attachments.Default);
            options.Conventions.AuthorizePage("/Attachments/CreateModal", BookStorePermissions.Attachments.Create);
            options.Conventions.AuthorizePage("/Attachments/EditModal", BookStorePermissions.Attachments.Edit);
        });
    }
